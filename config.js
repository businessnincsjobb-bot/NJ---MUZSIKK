...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "sgp.lavalink.yumistack.net", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 2333,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "Sakura", 
            ...
            bot: {
                ...
                defaultStatus: "🎵 Ready for sex!"         // 👈 Bot status message
            },
